<template>
  <div class="bg-white">
    ...
    <main class="isolate">
          ...
          <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
            <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <h1 class="text-4xl font-bold tracking-tight usr-color usr-font sm:text-6xl">
      ...
      <!-- Values section -->
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8 usr-font">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2 class="text-3xl font-bold tracking-tight usr-color sm:text-4xl">Some text</h2>
        ...
        >
          <div>
            <dt class="font-semibold usr-color">Be world-class</dt>
          ...
          <div>
            <dt class="font-semibold usr-color">Share everything you know</dt>
            <dd class="mt-1 text-gray-600">
          ...
          <div>
            <dt class="font-semibold usr-color">Always learning</dt>
            <dd class="mt-1 text-gray-600">
          ...
          <div>
            <dt class="font-semibold usr-color">Be supportive</dt>
            <dd class="mt-1 text-gray-600">
          ...
          <div>
            <dt class="font-semibold usr-color">Take responsibility</dt>
            <dd class="mt-1 text-gray-600">
          ...
          <div>
            <dt class="font-semibold usr-color">Enjoy downtime</dt>
            <dd class="mt-1 text-gray-600">
