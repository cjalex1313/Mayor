  ...
  <div class="relative bg-white">
    <div class="mx-auto max-w-7xl lg:flex lg:justify-between lg:px-8 xl:justify-end">
      ...
      <div class="px-6 lg:contents">
        <div
          class="mx-auto max-w-xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-lg lg:flex-none lg:pt-32 xl:w-1/2"
        >
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-[#002a59] sm:text-4xl">
            Emilia Neagu
          </h1>
          <p class="text-base font-semibold leading-7 text-[#ff0021]">Primar pentru Craiova</p>
          <p class="mt-6 text-xl leading-8 text-gray-700">
            Asemenea oricărui cetățean al municipiului, am întâmpinat dificultăți în interacțiunile
            cu administrația locală şi am cunoscut neajunsurile unui oraș în care interesul politic
            și nepotismul primează în faţa competenţei.
          </p>
          ...
          <p class="mt-3 text-xl leading-8 text-gray-700">
            Eu voi fi primarul care investeşte banii publici în toate cartierele, în educație,
            sănătate şi siguranță publică.
          </p>
          <p class="mt-3 text-xl leading-8 text-gray-700">
            Primarul care aduce investiții, locuri de muncă mai multe și mai bine plătite.
          </p>
          <p class="mt-3 text-xl leading-8 text-gray-700">
            Folosește-ti votul din 9 iunie și intră in echipa mea pentru a alege schimbarea de care
            toţi avem nevoie.
          </p>
